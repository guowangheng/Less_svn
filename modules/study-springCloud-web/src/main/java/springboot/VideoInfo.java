...
public class VideoInfo
{
    ...
    {
        VideoInfo videoInfo = new VideoInfo("E:\\软件下载\\ffmpeg-20180803-476fd6b-win64-static\\bin\\ffmpeg.exe");
        try
        {
            videoInfo.getInfo("E:\\baidu\\BaiduNetdisk\\download\\springcloud教程\\springboot实战项目类\\2017年-传智播客SpringBoot视频教程\\视频\\01-Spring的发展.avi");
